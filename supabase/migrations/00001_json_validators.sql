-- Migration: 00001_json_validators
-- Date: 2026-09-24
-- Affects: function
-- -------------------------------------------------------
-- Structural validators for JSONB documents (program AST, scene, goals). They mirror the
-- zod/JSON schemas of packages/blocks and are used in CHECK constraints, so a broken
-- document can never be stored even if a client bypasses the app.
